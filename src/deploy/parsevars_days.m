function sim_out = parsevars_days(r,ds,crop,full_data,t0)
...
tspan = r.tout; %  Grid temporal
x_out = r.yout; % Variables de salida del modelo
%
%
...
%
dC_1 = sim_out.crop_st.C_Total(end) -  sim_out.crop_st.C_Total(1);
dC_2 = sim_out.crop_st_2.C_Total(end) -  sim_out.crop_st_2.C_Total(1);

sim_out.total.carbon = dC_1 + dC_2;
